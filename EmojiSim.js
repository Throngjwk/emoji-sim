...
var id = "Emojipedia?";
var name = "Emoji Simulator";
var description = "emoji sim not this know?";
...
var init = () => {
    ...
    currency_slimefacewithtear = theory.createCurrency(getUnicodeSearchEmoji("U+1F972", "14"), getUnicodeSearchEmoji("U+1F972", "14"));
    ...
    /////////////////
    //// Achievements
    achievement1 = theory.createAchievement(0, "Achievement 1", "AAA", () => c1.level > 1);
    ...
    function getUnicodeSearchEmoji(codepoint, older_ver) {
        if (older_ver == "14") {
            if (codepoint == "U+1F600") {
                return "😀";
            }
            if (codepoint == "U+1F601") {
                return "😁";
            }
            if (codepoint == "U+1F602") {
                return "😂";
            }
            if (codepoint == "U+1F603") {
                return "😊";
            }
            if (codepoint == "U+1F680") {
                return "🚀";
            }
            if (codepoint == "U+1F972") {
                return "🥲";
            }
            if (codepoint == "U+1F5FF") {
                return "🗿";
            }
            if (codepoint == "U+1F5AA") {
                return "🖪";
            }
            if (codepoint == "U+1FAAA") {
                return "🪪";
            }
            if (codepoint == "U+1FAAB") {
                return "🪫";
            }
        }
        if (older_ver == "13") {
...
var tick = (elapsedTime, multiplier) => {
    ...
    currency_slimefacewithtear.value += BigNumber.from(0.1)
